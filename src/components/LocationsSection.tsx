...
const LocationsSection = () => {
  return <section className="py-24 bg-gradient-to-b from-charcoal to-background relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        duration: 0.8
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            <span className="text-foreground">​مواقعنا </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {locations.map((location, index) => <motion.div key={location.id} initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          delay: index * 0.2
              ...
              {/* Phone */}
              <a href={`tel:+963${location.phone.slice(1)}`} className="inline-flex items-center gap-2 text-gold hover:text-gold-light transition-colors">
